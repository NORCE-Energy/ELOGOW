package ELOGOW
  ...
  package Interfaces
    connector Energy
      SI.Energy E;
      annotation (
        Icon(graphics={  Ellipse(origin = {-8, -45}, rotation = 90, lineColor = {0, 170, 0}, fillColor = {0, 170, 0}, lineThickness = 1, extent = {{-12, -17}, {76, -1}}, endAngle = 360), Text(origin = {-49, 111}, extent = {{99, -65}, {-5, 3}}, textString = "%name"), Ellipse(origin = {0, -17}, lineColor = {0, 170, 0}, fillColor = {0, 170, 0}, lineThickness = 1, extent = {{-40, -5}, {44, 9}}, endAngle = 360), Ellipse(origin = {42, 21}, rotation = 90, lineColor = {0, 170, 0}, fillColor = {0, 170, 0},
                lineThickness =                                                                                                                                                                                                        1, extent = {{-72, 3}, {4, 77}}, endAngle = 360), Rectangle(origin = {69, -10}, extent = {{-15, 14}, {15, -14}})}, coordinateSystem(initialScale = 0.1)),
        Diagram(graphics={  Rectangle(origin = {69, -10}, extent = {{-15, 14}, {15, -14}}), Text(origin = {-49, 111}, extent = {{99, -65}, {-5, 3}}, textString = "%name"), Ellipse(origin = {0, -17}, lineColor = {0, 170, 0}, fillColor = {0, 170, 0}, lineThickness = 1, extent = {{-40, -5}, {44, 9}}, endAngle = 360), Ellipse(origin = {42, 21}, rotation = 90, lineColor = {0, 170, 0}, fillColor = {0, 170, 0}, lineThickness = 1, extent = {{-72, 3}, {4, 77}}, endAngle = 360), Ellipse(origin = {-8, -45}, rotation = 90, lineColor = {0, 170, 0}, fillColor = {0, 170, 0},
                lineThickness =                                                                                                                                                                                                        1, extent = {{-12, -17}, {76, -1}}, endAngle = 360)}));
    end Energy;
  ...
  package Sensors
    ...
    equation
      V = Error * P.P;
      annotation (
        Icon(graphics={  Text(origin = {6, 74}, extent = {{-42, 12}, {42, -12}}, textString = "%name"), Line(origin = {83.9004, -0.19018}, points = {{-21, 0}, {-15, 0}}, thickness = 1), Ellipse(origin = {16, 12}, fillColor = {103, 103, 103}, fillPattern = FillPattern.Solid, extent = {{-62, -64}, {46, 42}}, endAngle = 360), Polygon(origin = {20, 10}, rotation = -17.5, fillColor = {234, 234, 234}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{-9, -12}, {-2, 30}, {2, 39}, {2, 30}, {-5, -12}, {-9, -12}}), Ellipse(origin = {8, 0}, fillColor = {223, 223, 223}, pattern = LinePattern.None,
                fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-7, -7}, {7, 7}}, endAngle = 360)}, coordinateSystem(initialScale = 0.1)));
    end PowerSensor;
  ...
  package Systems
    ...
    equation
      ...
      annotation (
        Icon(graphics={  Text(origin = {-67, 63}, extent = {{-59, 23}, {-27, -13}}, textString = "SP Inlet"), Text(origin = {18, 66}, extent = {{-24, 10}, {6, -2}}, textString = "E"), Rectangle(origin = {43, 71}, extent = {{-183, 29}, {95, -101}}), Text(origin = {113, 71}, extent = {{-13, 9}, {13, -9}}, textString = "MPout"), Text(origin = {-13, 65}, extent = {{-59, 23}, {-21, -17}}, textString = "SP Outlet"), Rectangle(origin = {63, 26}, rotation = 90, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-55, 2}, {33, -68}}), Text(origin = {76, 63}, extent = {{-14, 19}, {4, -3}}, textString = "MPin"), Rectangle(origin = {-11, 4}, rotation = 90, fillColor = {0, 170, 0},
                fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-33, 128}, {55, -72}}), Polygon(origin = {-8, 20}, rotation = 90, fillColor = {255, 255, 255},
                fillPattern =                                                                                                                                                                                                        FillPattern.Solid, points = {{4, 68}, {-18, -2}, {-4, 4}, {-14, -52}, {6, 12}, {-8, 8}, {-6, 12}, {4, 68}})}, coordinateSystem(extent = {{-140, -100}, {140, 100}}, initialScale = 0.1)),
    ...
    equation
      ...
      annotation (
        Icon(coordinateSystem(extent = {{-400, -400}, {400, 400}}), graphics={  Rectangle(extent = {{-313.02, 338.129}, {313.02, -338.129}}, origin = {-9.938140000000001, 0.829315}), Text(textString = "GTSP1", horizontalAlignment = TextAlignment.Left, extent = {{-239.561, 26.884}, {-85.56059999999999, -17.116}}, origin = {-68.43940000000001, 195.116}), Text(textString = "Demand", extent = {{-69.7667, 36.1}, {112.233, -39.9}}, origin = {-186.233, -298.1}), Text(textString = "Battery  Level",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-367.11, 34.22}, {-131.11, -21.78}}, origin = {419.11, 281.78}), Text(textString = "CO2",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-121.334, 28.1111}, {-43.3334, -17.8889}}, origin = {207.334, -314.111}), Text(textString = "NOx",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-105.778, 28.1111}, {-37.7777, -17.8889}}, origin = {315.777, -310.111}), Text(textString = "GTP1",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-124.444, 46.4443}, {-44.4444, -29.5556}}, origin = {334.444, 169.556}), Text(textString = "WTP",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-118.222, 30.5555}, {-42.2222, -19.4445}}, origin = {336.222, -92.55500000000001}), Text(textString = "GTSP2",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-174.23, 39.104}, {-62.23, -24.896}}, origin = {-139.77, 100.896}), Text(textString = "GTP2",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-124.444, 41.5555}, {-44.4444, -26.4445}}, origin = {330.444, 74.44499999999999}), Text(textString = "Start/Stop",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left,
                lineThickness =                                                                                                                                                                                                        1, extent = {{-118.372, 48.88}, {67.6284, -31.12}}, origin = {-193.628, 285.12}), Text(textString = "Bi",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-136.889, 35.4444}, {-48.8889, -22.5556}}, origin = {-169.111, -143.444}), Text(textString = "Bo",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-96.4444, 33}, {-34.4444, -21}}, origin = {-219.556, -255}), Text(textString = "WS",
                horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left, extent = {{-121.333, 34.2222}, {-43.3334, -21.7778}}, origin = {-184.667, -8.222200000000001})}),
  ...
  package GasTurbines
    ...
    equation
      ...
      connect(Psp, product.u2) annotation (
        Line(points={{-335,133},{82,133},{82,269.6},{244.2,269.6}},    color = {0, 0, 127}));
      connect(product.y, feedback.u1) annotation (
        Line(points={{356.9,299},{386,299},{386,-14},{-252,-14},{-252,-93},{-192.2,-93}},          color = {0, 0, 127}));
      connect(Pout, powerSensor.P) annotation (
        Line(points={{150,-302},{9.73,-302},{9.73,-310.29}}));
      connect(powerSensor.V, feedback.u2) annotation (
        Line(points={{-93.22,-311},{-137,-311},{-137,-148.2}},   color = {0, 0, 127}));
      connect(greaterThreshold.y, booleanToReal.u) annotation (
        Line(points={{41,310},{74,310},{74,331},{104.6,331}},        color = {255, 0, 255}));
      connect(booleanToReal.y, product.u1) annotation (
        Line(points={{189.7,331},{244.2,331},{244.2,328.4}},color = {0, 0, 127}));
      connect(feedback.y, pi.u) annotation (
        Line(points={{-74.9,-93},{-36,-93},{-36,-138},{26.4,-138}},      color = {0, 0, 127}));
      annotation (
  ...
  package Paper
    ...
    equation
      connect(setpoint_inlet.y, batterySystem.SPInlet) annotation (
        Line(points={{-72.9,-67},{-23,-67},{-23,-89.9571},{10.0143,-89.9571}},
                                                                       color = {0, 0, 127}));
      connect(setpoint_out.y, batterySystem.SPOutlet) annotation (
        Line(points={{-79,44},{-30,44},{-30,-29.8714},{10.0143,-29.8714}},
                                                                     color = {0, 0, 127}));
      annotation (
    ...
    equation
      connect(booleanPulse.y, gasTurb.u) annotation (
        Line(points={{-137.7,219},{-2,219},{-2,152.22},{80.6,152.22}},color = {255, 0, 255}));
      connect(const.y, gasTurb.Psp) annotation (
        Line(points={{-143.4,-138},{10,-138},{10,-35},{80.6,-35}},      color = {0, 0, 127}));
      annotation (
        Diagram(coordinateSystem(extent = {{-400, -400}, {400, 400}})),
    ...
    equation
      connect(eRA5Source.wind, wTSys.Wind) annotation (
        Line(points={{-212.32,177.82},{-212.32,322},{-100.2,322},{-100.2,-80.98}}));
      annotation (
        Diagram(coordinateSystem(extent = {{-400, -400}, {400, 400}})));
    end W;
    ...
    equation
      ...
      connect(sys.BE, trigger.BL) annotation (
        Line(points={{314.72,28.77},{348,28.77},{348,318},{-218.729,318},{-218.729,292.504}},
                                                                                    color = {0, 0, 127}));
      connect(sys.mgtp1, Opt.GT1) annotation (
        Line(points={{315.205,-21.185},{337,-21.185},{337,-22},{364,-22},{364,343},{-363.261,343},{-363.261,-48.2288}},
                                                                                                              color = {0, 0, 127}));
      connect(trigger.y, sys.trigger) annotation (
        Line(points={{-218.5,137.183},{-218.5,32.65},{-30.6,32.65}},
                                                                  color = {255, 0, 255}));
      connect(trigger.y, Opt.Trigger) annotation (
        Line(points={{-218.5,137.183},{-218.5,137.183},{-218.5,20.3},{-250.5,20.3},{-250.5,15.22}},       color = {255, 0, 255}));
      connect(Opt.GTSP1, sys.gtp1) annotation (
        Line(points={{-137.081,-41.6538},{-82,-41.6538},{-82,-11.485},{-32.055,-11.485}},
                                                                         color = {0, 0, 127}));
      connect(sys.mgtp2, Opt.GT2) annotation (
        Line(points={{314.72,-69.2},{393,-69.2},{393,377},{-391,377},{-391,-100.5},{-362.933,-100.5}},   color = {0, 0, 127}));
      connect(wind.y, sys.ws) annotation (
        Line(points={{-452.52,-281.32},{-73,-281.32},{-73,-108.485},{-32.055,-108.485}},
                                                                             color = {0, 170, 0}, pattern = LinePattern.Dash, thickness = 0.5));
      connect(Opt.GTSP2, sys.gtp2) annotation (
        Line(points={{-137.081,-86.3637},{-72,-86.3637},{-72,-55.62},{-31.57,-55.62}},
                                                                         color = {0, 0, 127}));
      connect(Opt.Bi, sys.bi) annotation (
        Line(points={{-137.081,-135.019},{-98,-135.019},{-98,-173.475},{-31.085,-173.475}},
                                                                             color = {0, 0, 127}));
      connect(Opt.Bo, sys.bo) annotation (
        Line(points={{-138.396,-167.236},{-112,-167.236},{-112,-226.34},{-31.57,-226.34}},
                                                                               color = {0, 0, 127}));
      connect(sys.wtp, Opt.WP) annotation (
        Line(points={{313.265,-149.225},{428,-149.225},{428,402},{-421,402},{-421,-180.058},{-360.96,-180.058}},
                                                                                                       color = {0, 0, 127}));
      connect(sys.CO2, emissionSensor.CO2) annotation (
        Line(points={{202.2,-289.39},{197,-289.39},{197,-317.15},{380.9,-317.15}},
                                                                            color = {0, 0, 127}));
      connect(sys.nox, emissionSensor.NOx) annotation (
        Line(points={{260.885,-287.935},{258,-287.935},{258,-373.85},{380.9,-373.85}},
                                                                            color = {0, 0, 127}));
      connect(PowerDemand.y, sys.demand) annotation (
        Line(points={{-336.35,-449.5},{56.7,-449.5},{56.7,-285.51}},
                                                                  color = {0, 0, 127}));
      connect(PowerDemand.y, Opt.Demand) annotation (
        Line(points={{-336.35,-449.5},{-249.514,-449.5},{-249.514,-216.549}},
                                                                      color = {0, 0, 127}));
      annotation (
